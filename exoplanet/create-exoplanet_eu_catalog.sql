-- Table: public.exoplanet_eu_catalog

-- DROP TABLE public.exoplanet_eu_catalog;

CREATE TABLE public.exoplanet_eu_catalog
(
...
ALTER TABLE public.exoplanet_eu_catalog
    OWNER to postgres;